...
let yingshengid1 = ($.isNode() ? process.env.yingshengid1 : $.getdata('yingshengid1')) || '';
let yingshengid2 = ($.isNode() ? process.env.yingshengid2 : $.getdata('yingshengid2')) || '';
let yingshengid3 = ($.isNode() ? process.env.yingshengid3 : $.getdata('yingshengid3')) || '';
let userList = []
                            ...
                            if(step.com_status == 12) {
                                ...
                                for(let i=0; i<num; i++) {
                                    if(task.title.indexOf('点赞') > -1) {
                                        ...
                                        this.userIdList[0]=yingshengid1
                                        this.userIdList[1]=yingshengid2
                                        this.userIdList[2]=yingshengid3
                                        let uid = this.userIdList[i]
                                        await $.wait(TASK_WAIT_TIME);
