...
#     print('>>>>>>>开始获取版本信息...')
#     baseurl = 'http://gh.tt.ma/https://github.com/zjk2017/CHERWIN_SCRIPTS/raw/main/'
#     TOOLS_NAME = 'CHERWIN_TOOLS.py'
#     server_script_url = f'http://gh.tt.ma/https://github.com/zjk2017/CHERWIN_SCRIPTS/raw/main/{TOOLS_NAME}'
#     try:
...
def CHECK():
    global CHERWIN_SCRIPT_CONFIG
    print('>>>>>>>开始获取版本信息...')
    baseurl = 'https://github.com/zjk2017/CHERWIN_SCRIPTS/raw/main/'
    TOOLS_NAME = 'CHERWIN_TOOLS.py'
...
def main(APP_NAME, local_script_name, ENV_NAME, local_version, need_invite=False):
    ...
    git_url = f'https://github.com/zjk2017/CHERWIN_SCRIPTS/raw/main/{local_script_name}'
    if CHECK():
