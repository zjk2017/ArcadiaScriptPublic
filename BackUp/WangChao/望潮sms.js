...
async function main() {
    ...
    console.log("打印verify")
    // console.log(util.inspect(verify));
    ...
    console.log("获取sessionId")
    console.log(sessionId)
    let WangChao = ($.isNode() ? JSON.parse(process.env.WangChao) : $.getjson("WangChao")) || [];
    // console.log("获取WangChao ck")
    // console.log(util.inspect(WangChao));
