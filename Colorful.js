 ...
 * export COLORFUL_RAFFLE='true' //开启抽奖 
 修复ck过期没有任务日志且 域名填到变量 0830 export COLORFUL_HOST='shop.skycolorful.com:45677' //host
 */
const $ = new Env('七彩虹商城')
...
const COLORFUL = ($.isNode() ? (process.env.COLORFUL ? JSON.parse(process.env.COLORFUL) : undefined) : $.getjson("COLORFUL")) || [],
    COLORFUL_RAFFLE = ($.isNode() ? process.env.COLORFUL_RAFFLE : $.getjson("COLORFUL_RAFFLE")) === 'true' || false,COLORFUL_HOST = ($.isNode() ? process.env.COLORFUL_HOST : $.getjson("COLORFUL_HOST")) || 'shopapitest.skycolorful.com';
const baseUrl =COLORFUL_HOST
