...
青龙：
1.登录后抓包 fwdt.shengongshe.org域名的Token，填写到sgs_data,多账号用 @ 分割
2.可选推送：将bark的key填写到bark_key，不填默认使用青龙自带的推送

Loon: 
1.复制Cookie脚本到本地
2.打开小程序->签到任务，若提示获取Cookie成功则可以使用该脚本
3.关闭Cookie脚本

[Script]
cron "6 6 * * *" script-path=https://raw.githubusercontent.com/Sliverkiss/helloworld/master/Study/sgs.js, timeout=300, tag=申工社
