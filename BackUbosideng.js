...
async function records() {
    ...
    let nonce = $.uuid()
    let appId = $.appId
    // nonce='68e017c6-8cb8-48d9-91b4-ff244e2b2592'
    ...
    if (result.code == 200) {
        ...
        $.log(`❌ 签到信息查询失败，原因：${JSON.stringify(result)}`)
    }
}
